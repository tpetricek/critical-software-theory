...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth]{chapters/fig/strip.jpg}\quad
...
\centering
\vspace{-1em}
\includegraphics[width=0.8\textwidth]{chapters/fig/foquet.jpg}
...
\begin{figure}[t]
\vspace{-1em}
\includegraphics[height=10em]{chapters/fig/fit-jihocesky.jpg}\quad
\includegraphics[height=10em]{chapters/fig/fit-dobravoda.jpg}\quad
\includegraphics[height=10em]{chapters/fig/fit-house-vi.jpg}\\[1em]
\includegraphics[height=10.7em]{chapters/fig/fit-isokon.jpg}\quad
\includegraphics[height=10.7em]{chapters/fig/fit-tugendhat.jpg}\\[1em]
\includegraphics[height=10.6em]{chapters/fig/fit-sala-house.jpg}\quad
\includegraphics[height=10.6em]{chapters/fig/fit-strip.jpg}\quad
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth]{chapters/fig/resurrection.png}
\caption{.}
\label{fig:hotel}
% https://geocities.restorativland.org/ResearchTriangle/2387/
\end{figure}
...
It also typically only needs to address problems of limited complexity. Vernacular architecture
develops over long period of time, so its relevance to the world of software is not obvious.
Yet, there are some connections worth exploring.

First of all


The world of software is


VERNACULAR

c.f. golden era of HTML -
%http://contemporary-home-computing.org/prof-dr-style/
%digital folklore reader - https://monoskop.org/images/9/91/Lialina_Olia_Espenschied_Dragan_eds_Digital_Folklore_2009.pdf


in PL, architecture destroyed hacker culter (c.f. Notes, p58)

our attitude condescending (Rudofsky) - take indigenous sw more seriously?
R?

much to learn from architecture before it became experts art
proto-systems?


craft/learned through practice
