...
example such as the two recursive computations shown in Figure~\ref{fig:ycombinator}.\endnote{The
...
Intelligence''\endnote{\citet{russell-2015-letter}} (Figure~\ref{fig:ai}). The introduction of the letter talks
