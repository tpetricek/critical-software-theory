...
In the previous two sections, I focused on ideas that approach architecture, starting from
the particular, specifically the structural element of a column. I will now look at ways
of developing critical language starting from the general.
I look at a number of works, mainly by Peter Eisenman, that relate architecture to
language, art and their formal structures and grammar (Figure~\ref{fig:grammar}).

Perhaps the most explicit reference to formal grammar in the context of architecture comes
...
structures from which architectural form arises. The view opposes both that of Christopher
Alexander\endnote{see debate} and modernists who saw form as arising from function.
...
The start of the 1960s, when Eisenman developed his formal analysis, was likely a good time
for such work. In the preceding years, the linguist Noam Chomsky published his first works
on formal languages and grammars. Reading of Chomsky influenced Eisenman\endnote{Oppositions, 202}
and the same ideas also influenced computer scientists and led to the develpment of formal
grammars of programming languages.\endnote{Algol}
...
between them that lead to distortions of the basic structure.
...
the rear facade. To accommodate access to the inner courtyard, resulting from the centroidal
...
(necessary) principles. Eisenman himself went on to explore various uses of a formal architectural
...
starting point, replacing the conventional cube. The design also disrupts the centraility that
is typical of most houses.
...
and their conventional meaning. In the late 1980s, Eisenman collaborated with Derrida on a
...
of architecture. The fact that this introduces disharmony in the project has become contentious
issue. While, Eisenman argued that an importnat role of art and architecture is
reminding people that ``everything isn't all right'', Christopher Alexander is ``incredibly
angry'' and sees projects that introduce disharmony as ``fucking up the world''.\endnote{debate}
...
His formal structures are inspired less by formal grammars of Chomsky, but by avant-garde artists
...
times, since he will smash an existing building into parts, leave elements ofhis own work
unfinished and (...) make an aesthetic virtue of rough, crumbled surfaces.''\endnote{Deconstruction
in Architecture (Papadakis, ed.) - p18} Yet, despite the different conceptualization of the work,
there is a clear connection between the work of Eisenman and Gehry. In some of their works, they
both try to uncover basic forms that comprise architectural structures and reveal them through
distortion.
...
TODO: Eisenman memorial

(also, park and memorial are heterotopias good for exploring ideas)
...
eventually evolved into an architectural movement known as
deconstructivism.

The work of Noam Chomsky in the late 1950s was one
