...
\begin{figure}
\centering
\includegraphics[height=14em]{fig/nursehq.jpg}\quad
\includegraphics[height=14em]{fig/nursehq-floor.png}
...
There are at least three different ideas that we can use to look at software, which arise
from the work of Robert Venturi, Denise Scott Brown and their collaborators.
...
Sometimes, there are two ways of
...
There are two lessons that we can
...
\section{Fit Emergent from Formal Structures}
