...
No Silver Bullet,\endnote{cite} published in 1986, where he argued that:
...
was intended as ``a study of method, not content.''\endnote{Vegas, p6} How else can we learn
...
1970s,\endnote{CSP paper; also see ``A Brief History of Process Algebra''.}
...
programming ideas.''\endnote{CSP paper}
...
it.''\endnote{Turner, ``Some History of Functional Programming Languages''} The specific
example of functional list processing also does not require nearly the full power (or even the
key structures) of the lambda calculus.\endnote{See \url{https://programming-journal.org/2020/4/8/}}
...
the less satisfactory features of purely functional languages.''\endnote{Imperative FP}
...
of both programmer and implementor.\endnote{Imperative functional programming}
\end{quote}
...
function, and meaning.\endnote{From Formalism to Weak Form: The Architecture and Philosophy of
Peter Eisenman, p33}
\end{quote}
...
their~lives.\endnote{\url{https://www.archdaily.com/63267/ad-classics-house-vi-peter-eisenman}}
\end{quote}
...
talk about monads''\endnote{paper} I pointed out that ``there are a number of cases where monads
...
The first example is that of monadic parser combinators.\endnote{cite} Parser combinators
...
by Dominic Orchard,\endnote{cite} computer scientists initially tried to model dataflow
...
of personal data or the role of social media.\endnote{Weapons of Math Destruction, Algorithms of Oppression,
The Age of Surveillance Capitalism, Twitter and Tear Gas}
...
Intelligence''\endnote{cite} (Figure~\ref{fig:ai}). The introduction of the letter talks
...
approaches:\endnote{Oppositions, p372}
...
perceivable changes.''\endnote{Oppositions p376} The changes introduce figures such as hyperboles,
...
architecture commenting on architecture, architecture `speaking' of itself.''\endnote{Oppositions, p376}
...
Charles Jencks opens his book ``The Story of Post-Modernism''\endnote{cite} with an answer to
...
of catalogue shopping'' for children eligible for adoption.\endnote{\url{https://journals.sagepub.com/doi/10.1177/14614448231156852}}
...
purposes.\endnote{see \texttt{./code --poetry} book} The semantic flexibility also gives
code aesthetical qualities that have been used for different purposes and are judged differently
by different readers.\endnote{Depaz; see also 10 PRINT book, critical code studies, Foo bar paper}
...
(to what degree is there a fixed structure for the data and relationships).\endnote{Joel's goblin example}
...
\subsection{Transparency and Methodological Freedom}
...
wish''.\endnote{manifesto} This may have been the case about free software in the 1980s when
...
itself.\endnote{quote somewhere in the BYTE magazing}
