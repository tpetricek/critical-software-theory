...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{fig/pruitt-igoe.jpg}
...
The later design of the TypeScript type system deserves a further analysis. Later versions
continued adding type system features that reflected typical (non-modernist) coding patterns
